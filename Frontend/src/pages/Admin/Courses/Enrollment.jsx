    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                {/* Filters Section - Only show if there are enrollments */}
                        ...
                        <div className="relative bg-gradient-to-r from-indigo-600 to-purple-600 rounded-t-2xl px-6 py-6">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-indigo-100 text-sm">ID: {selectedEnrollment.enrollmentId?.slice(-8)}</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="mb-6">
                                ...
                                <div className="bg-slate-50 rounded-xl p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <span className="text-sm font-medium text-slate-700">{selectedEnrollment.studentName}</span>
                                    </div>
                                    <div>
                                        <span className="text-xs text-slate-500 block">Email Address</span>
                                        <span className="text-sm font-medium text-slate-700">{selectedEnrollment.email}</span>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <span className="text-sm font-medium text-slate-700">{selectedEnrollment.studentGender}</span>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <span className="text-sm font-medium text-slate-700">{selectedEnrollment.studentAddress}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="mb-6">
                                ...
                                <div className="bg-slate-50 rounded-xl p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <span className="text-sm font-medium text-slate-700">{selectedEnrollment.courseTitle}</span>
                                    </div>
                                    <div>
                                    ...
                                    <div className="md:col-span-2">
                                        ...
                                        <span className="text-sm font-medium text-slate-700">{selectedEnrollment.courseDescription}</span>
                                    </div>
                                </div>
                            </div>
